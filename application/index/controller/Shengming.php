...
class Shengming extends Controller
{
	...
	public function getchart()
	{
		...
		$data['kaipan'] = \think\Lang::get('cs_kp');
		$data['zuidi'] = \think\Lang::get('iin_zd');
		$data['zuigao'] = \think\Lang::get('iin_zg');
		$data['Kxian'] = 'k'.\think\Lang::get('iin_kx');
		$data['zoushi'] = \think\Lang::get('iin_zs');
		$data['DIFF'] = 'DIFF:';
		$data['DEA'] = 'DEA:';
		$data['MACD'] = 'MACD:';
		$data['chicang'] = \think\Lang::get('gs_cc').':';
		$data['maizhang'] = \think\Lang::get('iin_mz');
		$data['maidie'] = \think\Lang::get('iin_md');
		$data['xiushi'] = \think\Lang::get('iin_xs');
		$data['tousijine'] = \think\Lang::get('iin_tzje');
