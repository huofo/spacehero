...
*/
        ...
        //今日客户盈亏
        $tody_profit = Db::name('order')->where($map)->field('SUM(ploss) as ploss')->whereTime('selltime', 'd')->select();
        ...
        //今日手续费
        $data['tody_shouxu'] = Db::name('order')->where($map)->whereTime('selltime', 'd')->sum('sx_fee');
