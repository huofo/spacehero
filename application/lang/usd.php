...
//    'qsryhm' => 'aaaaaa',
    ...
    'fbjy_kjq'=>"Shortcut area",
    'fbjy_gmje'=>"Purchase amount",
    'fbjy_esq'=>"20 cases",
    'fbjy_ybq'=>"100 cases",
    'fbjy_ckdj'=>"Reference unit price",
    'fbjy_aslgm'=>"Purchase by quantity",
    'fbjy_ajegm'=>"Purchase by amount",
    'fbjy_lsxfgm'=>"0 handling charge purchase",
    'fbjy_cssl'=>"Quantity sold",
    'fbjy_hz'=>"Transfer",
    'fbjy_zdksw'=>"The maximum available for sale is",
    'fbjy_aslcs'=>"Sell by quantity",
    'fbjy_ajecs'=>"Sale by amount",
    'fbjy_lsxfcs'=>"0 commission sale",
    'fbjy_yjmmksjy'=>"One click trading, fast Trading",
    'fbjy_zxq'=>"Optional area",
    'fbjy_gdxzzyjy'=>"More options, free trade",
    'fbjy_xzfb'=>"Select legal currency",
    'fbjy_qsrfb'=>"Please enter legal currency",
    'fbjy_qrcs'=>"Confirm sale",
    'fbjy_zfb'=>"Alipay",
    'fbjy_djzy'=>"Optimal unit price",
    'fbjy_zwzffs'=>"No payment method",
    'fbjy_wx'=>"WeChat",
    'fbjy_yhk'=>"bank card",
    'fbjy_tjskfs'=>"Add collection method",
    'fbjy_qrgm'=>"Confirm purchase",
    'fbjy_wjsd'=>"I will receive",
    'fbjy_xzzffs'=>"Select payment method",
    'fbjy_qsrgmje'=>"Please enter the purchase amount",
    'fbjy_qsrgmdjebnxy'=>"The purchase amount entered cannot be less than or equal to 0",
    'fbjy_qsrgmsl'=>"Please enter the purchase quantity",
    'fbjy_qsrgmdbnxy'=>"The quantity entered for purchase cannot be less than or equal to 0",
    'fbjy_qsrgmslje'=>"Please enter the purchase quantity and amount",
    'fbjy_qsrcsslhje'=>"Please enter the sales quantity or amount",
    'fbjy_srcsdslhjebnxyl'=>"The quantity or amount entered for sale cannot be less than or equal to 0",
    'fbjy_qsrgmslhje'=>"Please enter the purchase quantity or amount",
    'fbjy_qsrgmdslhjebn'=>"The quantity or amount entered for purchase cannot be less than or equal to 0",
    'fbjy_qxzskfs'=>"Please select the collection method",
    'fbjy_qsrcssl'=>"Please enter the quantity for sale",
    'fbjy_srcsdslbnxyh'=>"The quantity entered for sale cannot be less than or equal to 0",
    'fbjy_qsrcsjesl'=>"Please enter the sales amount and quantity",
    'fbjy_sqcsdjebnxy'=>"The amount entered for sale cannot be less than or equal to 0",
    'fbjy_aqyz'=>"Security verification",
    'fbjy_yxyz'=>"Mailbox verification",
    'fbjy_jfsyzmdnn'=>"Will send verification code to your",
    'fbjy_yxyzm'=>"Email verification code",
    'fbjy_aqyzbky'=>"Security authentication is not available",
    'fbjy_qtxyzm'=>"Please fill in the verification code",
    'fbjy_ddlb'=>"Order list",
    'fbjy_rgnyjxmjfk'=>"If you have paid the seller, please do not cancel the order",
    'fbjy_mjdljsbqx'=>"When the buyer cancels three times in total, the buying function of the same day will be limited",
    'fbjy_qgswmnwsm'=>"Please tell us why you want to cancel the order?",
    'fbjy_wbxjyl'=>"I don't want to trade",
    'fbjy_wbmzggjy'=>"I don't meet the terms of the advertising transaction",
    'fbjy_mjyewsqfz'=>"The seller will charge an extra fee",
    'fbjy_mjskfsywt'=>"There is a problem with the seller's collection method and payment cannot be made successfully",
    'fbjy_qt'=>"other",
    'fbjy_qsrqxly'=>"Please enter cancellation reason",
    'fbjy_qrqxdd'=>"Confirm cancel order",
    'fbjy_lxmj'=>"Contact seller",
    'fbjy_yqx'=>"Cancelled",
    'fbjy_nyqxdd'=>"You have cancelled the order",
    'fbjy_zj'=>"Total price",
    'fbjy_ddh'=>"order number",
    'fbjy_cjsj'=>"Creation time",
    'fbjy_snnzj'=>"Safety of raw cattle funds",
    'fbjy_mjnc'=>"Seller nickname",
    'fbjy_ks'=>"indictment",
    'fbjy_grzh'=>"individual account",
    'fbjy_txlb'=>"Withdrawal list",
    'fbjy_yxje'=>"Withdrawal amount",
    'fbjy_yjj'=>"Rejected",
    'fbjy_ytg'=>"Passed",
    'fbjy_dj'=>"Unit Price",
    'fbjy_ddmjqrsk'=>"Wait for the seller to confirm the collection",
    'fbjy_nrwcfkqlx'=>"If you complete the payment, please contact the other party for confirmation",
    'fbjy_fkfs'=>"payment method",
    'fbjy_hykh'=>"Bank name",
    'fbjy_skewm'=>"Collection QR code",
    'fbjy_jytk'=>"Transaction terms",
    'fbjy_xkt'=>"Kjw small class",
    'fbjy_drqxddsc'=>"If the order is cancelled three times on the same day, the trading function of the same day will be limited.",
    'fbjy_qxdd'=>"cancellation of order",
    'fbjy_ss'=>"appeal",
    'fbjy_mjdeljqx'=>"The buyer cancels 3 times in total on the same day, which will limit the buying function on the same day",
    'fbjy_qxzqxdd'=>"Please select the reason for canceling the order",
    'fbjy_wlcc'=>"Network error",
    'fbjy_zde'=>"Maximum amount",
    'fbjy_zdl'=>"Maximum quantity",
    'fbjy_ze'=>"total",
    'fbjy_jyqqzxyd'=>"Please read the trading terms below carefully before trading",
    'fbjy_jyxx'=>"Transaction information",
    'fbjy_fksx'=>"Payment time limit",
    'fbjy_swfz'=>"15 minutes",
    'fbjy_jyfs'=>"transaction mode",
    'fbjy_wxts'=>"Warm out tips: 1. After buying money, withdraw the money to untrusted platforms such as pig killing plate, MLM plate, etc., and your assets will not be taken out from such platforms. 2. Buying money under the inducement of others' arbitrage, airdrop, etc. will cause your asset loss. 3. If you buy money for others, withdraw money and assist others in committing a crime, you will be prosecuted by the judiciary. Please be aware that (I have assisted the public security organ to arrest 3 people) a liar used Hong Kong telephone, pretended to be the customer service of coin security or called the security center to inform you that an order involving black money account was controlled by the wind on a certain day of a certain month, and then you will be asked to do the next operation in some forms. Never believe!!!!! (strictly check the 3-7 day flow) credit card loan, salary and cash deposit give priority to transactions.",
    'fbjy_cs'=>"sell",
    'fbjy_zdkm'=>"Maximum saleable amount",
    'fbjy_zdkml'=>"Maximum saleable volume",
    'fbjy_qsrcsje'=>"Please enter the sale amount",
    'fbjy_qxmjfk'=>"Please pay the seller",
    'fbjy_xm'=>"full name",
    'fbjy_skzh'=>"Collection account number",
    'fbjy_bz'=>"remarks",
    'fbjy_zysx'=>"matters needing attention",
    'fbjy_yssmjskfs'=>"The above is the seller's collection method. Please pay offline, and then click I have completed payment",
    'fbjy_qsybrsmzh'=>"Please use your real name account to transfer money to the other party. Please do not close this page until payment is completed.",
    'fbjy_wywcfk'=>"I have completed the payment",
    'fbjy_mjxx'=>"Seller information",
    'fbjy_nyxmjfk'=>"If you have paid the seller, please do not cancel the order",
    'fbjy_qngswwsm'=>"Please tell us why you want to cancel the order?",
    'fbjy_mjsffsywt'=>"There is a problem with the seller's collection method and payment cannot be made successfully?",
    'fbjy_tj'=>"add to",
    'fbjy_qsrnbzsxm'=>"Please enter your official name",
    'fbjy_zh'=>"account number",
    'fbjy_qsrnd'=>"Please enter your",
    'fbjy_qsryhkmc'=>"Please enter bank name",
    'fbjy_qsrkhzhmc'=>"Please enter the name of the account opening branch",
    'fbjy_qsrbz'=>"Please enter comments",
    'fbjy_sjewmbt'=>"Collection QR code (required)",
    'fbjy_sc'=>"upload",
    'fbjy_wxtsdnd'=>"Warm tip: when you sell digital currency, the collection method you choose will be displayed to the buyer. Please confirm that the information is filled in accurately",
    'fbjy_qqycqcs'=>"Request exception, please try again",
    'fbjy_scpz'=>"Upload voucher",
    'fbjy_srsl'=>"Please enter quantity",
    'fbjy_jyqqxzxyd'=>"Please read the trading terms below carefully before trading",
    'fbjy_bxlm'=>"Currency demand Alliance",
    'fbjy_nhwtjskfs'=>"You have not added this collection method",
    'fbjy_cdl'=>"Order quantity",
    'fbjy_qtxje'=>"Please fill in the amount",
    'fbjy_txsl'=>"Please fill in the quantity",
    'fbjy_ddmjfk'=>"Waiting for buyer's payment",
    'fbjy_lfz'=>"Fifteen minutes",
    'fbjy_yjz'=>"Expected in",
    'fbjy_nsdmjfk'=>"Payment received from buyer",
    'fbjy_sx'=>"Refresh",
    'fbjy_wdskfs'=>"My collection method",
    'fbjy_lbnh'=>"Hello, boss, please send the collection code in the chat window in the upper right corner (if there is a collection code, you don't need to reply)",
    'fbjy_yywsdfxtx'=>"Kjw has a perfect risk system to fully ensure your capital security",
    'fbjy_wyqrsk'=>"I have confirmed the receipt",
    'fbjy_qrsk'=>"Confirm receipt",
    'fbjy_qwbdlzh'=>'Please be sure to log in to the collection account and confirm that the amount has been received in the "available balance".',
    'fbjy_wyqrww'=>"I have confirmed that the collection is correct",
    'fbjy_jyxgdfxs'=>"It is suggested to negotiate with the other party first",
    'fbjy_kzltck'=>"The payment voucher and account information can be uploaded in the chat window for negotiation and verification by both parties",
    'fbjy_zxlt'=>"chat online",
    'fbjy_rwflxd'=>"If you can't contact the other party or solve it through negotiation, please click continue to appeal, and we will have customer service to help deal with it",
    'fbjy_jxss'=>"Continue to appeal",
    'fbjy_lxmj2'=>"Contact buyer",
    'fbjy_qqrsk'=>"Please confirm receipt",
    'fbjy_dfyfk'=>"The other party has paid. Please confirm the receipt",
    'fbjy_qqwyxzh'=>"Please go to the following account to confirm that the buyer has paid",
    ...
    'fbjy_wwsdk'=>"I didn't receive the payment",
    'fbjy_qrjjfx'=>"Confirm rejection of release order",
    'fbjy_bl'=>"no.",
    'fbjy_jjcg'=>"Reject successful!",
    'fbjy_qdjwyqr'=>"Please click I have confirmed that the collection is correct",
    'fbjy_mjqxdd'=>"The buyer cancelled the order!",
    'fbjy_qfk'=>"Please pay",
    'fbjy_fksysj'=>"Payment remaining time",
    'fbjy_qfk2'=>"To pay",
    'fbjy_ddysx'=>"The order has expired",
    'fbjy_xmsmjdsk'=>"The following is the seller's collection method. You need to leave the platform and transfer to the other party using your real name account.",
    'fbjy_zzsqw'=>"The following is the seller's collection method. You need to leave the platform and transfer to the other party using your real name account.",
    'fbjy_ydwt'=>"Problems?",
    'fbjy_xgskfs'=>"Modify collection method",
    'fbjy_wxtsdndsz'=>"Warm tip: when you sell digital currency, the collection method you choose will be displayed to the buyer. Please confirm that the information is filled in accurately.",
    'fbjy_lx'=>"contact",
    'fbjy_jycg'=>"Successful trade",
    'fbjy_nycg'=>"You have succeeded",
    'fbjy_zffs'=>"Payment method",
    'fbjy_gqdd'=>"Pending order",
    'fbjy_bppdd'=>"Matched order",
    'fbjy_ppdd'=>"Match order",
    'fbjy_ppddh'=>"Match order number",
    'fbjy_gqddh'=>"Pending order number",
    'fbjy_wcj'=>"No deal",
    'fbjy_csje'=>"Sale amount",
    'fbjy_gmsl'=>"Purchase quantity",

    'fbjy_qsczfpz'=>"Please upload payment voucher",
    'fbjy_qxzcbfs'=>"Please select the charging method",
    'fbjy_tjsb'=>"Submission failed",
    'fbjy_mj'=>"Buyers",
    'fbjy_mj2'=>"seller",
    'fbjy_yebz'=>"Sorry, your credit is running low",
    'fbjy_cwcs'=>"bad parameter",
    'fbjy_qtxjyd'=>"Please fill in the quantity or amount of the transaction",
    'fbjy_fbjycs'=>"Sale in legal currency transactions",
    'fbjy_m'=>"seller",
    'fbjy_m2'=>"buy",
    'fbjy_qzqwsk'=>"Please confirm or reject the payment at。",
    'fbjy_qqwzf'=>"Please go to pay。",
    'fbjy_nyygd'=>"You have a list",
    'fbjy_ddddwh'=>"order(Order tail number：",
    'fbjy_ppdl'=>"It matches）",
    'fbjy_ppddhw'=>"。Matching order number is：",
    'fbjy_ddppcg'=>"。Order matching succeeded：",
    'fbjy_ddscsb'=>"Order generation failed",
    'fbjy_gdcg'=>"Pending order succeeded",
    'fbjy_kjysl'=>"Insufficient tradable quantity, please select another order",
    'fbjy_ddppcg2'=>"Order matching succeeded",
    'fbjy_qtxwzxx'=>"Please complete the information",
    'fbjy_gsfsycz'=>"This collection method already exists",
    'fbjy_tjcg'=>"Added successfully",
    'fbjy_wzdgzdxx'=>"The payment information was not found",
    'fbjy_qszycs'=>"Missing main parameter",
    'fbjy_wzcw'=>"unknown error",
    'fbjy_yzmcw'=>"Verification code error",
    'fbjy_yzcg'=>"Validation succeeded",
    'fbjy_fbjy'=>"Sale of legal currency completed",
    'fbjy_tgfbjyhd'=>"Obtained through legal currency transaction",
    'fbjy_wcshcsbd'=>"No or wrong parameters",
    'fbjy_wcbzsj'=>"No data in this currency",
    'fbjy_nmyqxcz'=>"You do not have permission to operate",
    'fbjy_ddbkjj'=>"The order cannot be rejected",
    'fbjy_qxcg'=>"Cancellation succeeded",
    'fbjy_xjdd'=>"Shelf order off the shelf",
    'fbjy_gddbkqx'=>"This order cannot be cancelled",
    'fbjy_ddztygx'=>"Order status updated",
    'fbjy_gxsb'=>"Update failed",
    'fbjy_crs'=>"Acceptor",
    'fbjy_ks2'=>"Card dealer",
    'fbjy_dfk'=>"Pending payment",
    'fbjy_dmjqr'=>"To be confirmed by the seller",
    'fbjy_ssz'=>"In appeal",
    'fbjy_ysx'=>"Invalid",
    'fbjy_dmjfk'=>"To be paid by the buyer",
    'fbjy_dqr'=>"To be confirmed",
    'fbjy_yxq'=>"Cancelled",
    'fbjy_ywc'=>"Completed transaction",
    'fbjy_wdl'=>"Not logged in",
    'fbjy_tjsb2'=>"Add failed",
    'fbjy_qewc'=>"Confirm completion",
    'fbjy_ffz'=>"Illegal null value",
    'fbjy_csbwz'=>"Incomplete parameters",
    'fbjy_ddhycz'=>"Order number already exists",
    'fbjy_shbcz'=>"Merchant does not exist",
    'fbjy_yzsb'=>"Validation failed",

    'fbjy_fbzhsr'=>"Flash cash of legal currency account",
    'fbjy_srsl2'=>"Flash cash quantity",
    'fbjy_lksr'=>"Flash cash immediately",
    'fbjy_srcg'=>"Flash redemption succeeded",
    'fbjy_sr'=>"Flash exchange",
    'isdelete_confirm'=>"Confirm the deletion？",
    'isdelete_xzdtpzbhbzc'=>"The selected picture contains an unsupported format",
    'fbjy_parent_gain'=>"Referrer award",
    'fbjy_ka_daifu_fee'=>"Paid to reward",

    'isdelete_dzf'=>"To be paid",
    'isdelete_yzfdqr'=>"Paid to be confirmed",
    'isdelete_wwc'=>"Delivery completed",
    'isdelete_wzfsb'=>"Failure to pay",
    'isdelete_mjqxdd'=>"Buyer cancels order",
    'isdelete_mjjjdd'=>"Seller rejects order",
    'fbjy_ddhyczqsh'=>"Your order is under review. Please do not submit it again or try again later！",
