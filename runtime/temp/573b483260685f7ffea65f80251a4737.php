<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/agc.bxtrade.vip/application/index/view/goods/goods_heyue.html";i:1637657823;s:61:"/www/wwwroot/agc.bxtrade.vip/application/index/view/head.html";i:1636641480;}*/ ?>
...
<div class="nav-bar-block" nav-bar="active"><ion-header-bar class="bar-stable headerbar bar bar-header" align-title="center"><div class="buttons buttons-left" style="transition-duration: 0ms;"><span class="left-buttons">
    ...
    <style type="text/css" media="screen">
			...
			<ul class="nav-list" style="display: none; overflow-y: scroll; height: 100%;">
				<!--<li><a href="<?php echo url('/index/goods/goods/pid/12/token/'.$token); ?>">BTC/USD</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/26/token/'.$token); ?>">LTC/USD</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/9/token/'.$token); ?>">EUR/GBP</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/22/token/'.$token); ?>">USD/JPY</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/11/token/'.$token); ?>">GBP/CAD</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/10/token/'.$token); ?>">GBP/AUD</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/6/token/'.$token); ?>">EUR/USD</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/7/token/'.$token); ?>">GBP/USD</a></li>
				<li><a href="<?php echo url('/index/goods/goods/pid/8/token/'.$token); ?>">AUD/CAD</a></li>-->
                ...
                <li>
                    <a href="<?php echo url('/index/goods/goods_heyue',array('pid'=>$vo['pid'],'token'=>$token)); ?>"><?php echo $vo['ptitle']; ?></a>
                </li>
...
<ion-view   class="trade-view pane"  hide-nav-bar="false" state="trade" nav-view="active" style="opacity: 1; transform: translate3d(0%, 0px, 0px);">
    ...
    <?php if($isopen == 1): ?>
		...
		<section onClick="parent.location='<?php echo url('goods/heyuegoods',array('pid'=>$goods_id,'token'=>$token,'fangxiang'=>'0')); ?>';" class="">
			<i class="iconfont icon--17" style="color: #FFFFFF;"></i>
            <p class="" style="color: #FFFFFF;"><?php echo \think\Lang::get('gs_zd'); ?></p>
		</section>
		<section onClick="parent.location='<?php echo url('goods/heyuegoods',array('pid'=>$goods_id,'token'=>$token,'fangxiang'=>'1')); ?>';" class="">
			<i class="iconfont icon--18"></i>
            <p class="" style="color: #FFFFFF;"><?php echo \think\Lang::get('gs_zk'); ?></p>
		</section>
    <?php else: ?>
    ...
    <div class="order-confirm-panel" >
        ...
        <div class="panel-body">
            <div class="period" style="height: 80px;">
                ...
                <ion-scroll direction="x" class="scroll-view ionic-scroll scroll-x"><div class="scroll" style="transform: translate3d(0px, 0px, 0px) scale (1);">
                    <div class="period-widget-view close-position-view">
                        ...
                        <?php if($jiying==0): ?>
                        <div class="close-position active" data-sen="1" id='jiying'><?php echo \think\Lang::get('bii_mhy'); ?></div>
                         <?php endif; if($jinjie): ?>
                        <div class="close-position" data-sen="2"  id='jinjie'><?php echo \think\Lang::get('ind_hyjy'); ?></div>
                        <?php endif; ?>
            ...
            <div class="period second">
                <p class="end_time"><?php echo \think\Lang::get('sl_dqsj'); ?></p>
                <ion-scroll direction="x" class="scroll-view ionic-scroll scroll-x"><div class="scroll" style="transform: translate3d(0px, 0px, 0px) scale(1);">
                    <div class="period-widget-view">
                        ...
                        <div class="period-widget <?php if($k==1): ?> active <?php endif; ?>"  data-sen="<?php echo $vo*60; ?>" data-shouyi="<?php echo $proscale[$k-1]; ?>">
                            <div class="period-widget-header">
                                <?php echo \think\Lang::get('gb_jssj'); ?>
                            </div>
            ...
            <div class="info-view ">
                <div class="ng-binding my-money"><?php echo \think\Lang::get('gs_ye'); ?>:  $ <span class="pay_mymoney"><?php echo $userinfo['usermoney']; ?></span></div>
                <div class="ng-binding jixings"><?php echo \think\Lang::get('or_sxf'); ?>：<span><?php echo $web_poundage; ?></span>%</div>

                <div class="ng-binding jinjies" style="display:none" ><?php echo \think\Lang::get('or_sxf'); ?>：<span><?php echo $web_gratuity; ?></span>%</div>
            ...
            <div class="order-detail-view">
                <div class="order-detail">
                    ...
                    <div class="row">
                        ...
                        <div class="col ng-binding order_type" ><?php echo \think\Lang::get('iin_md'); ?></div>
                    ...
                    <p class="expect_profit">
                        <span class="ng-binding"><?php echo \think\Lang::get('gs_yqsy'); ?> :  $ <span id="yuqi">180.00</span></span>
                        &nbsp;&nbsp;
                        <span class="ng-binding"><?php echo \think\Lang::get('gs_bdje'); ?> :  $ 0.00</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="order-state-panel"  >
            ...
            <div class="panel-body">
                <div class="paysuccess  ng-hide" ng-show="order_result.status == 'SUCCESS'">
                    ...
                    <div class="row info_list">
                        ...
                        <div class="col col-25 last_info">
                            <p><?php echo \think\Lang::get('gb_ycjg'); ?></p>
                ...
                <div class="row button_row">
                    <div class="col">
                        <button class="button" onClick="continue_order()"><?php echo \think\Lang::get('gb_jxxd'); ?></button>
                    </div>
                </div>
            </div>
        </div>
