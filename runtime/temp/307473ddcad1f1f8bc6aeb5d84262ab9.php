<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/wwwroot/agc.bxtrade.vip/application/index/view/trades/index_heyue.html";i:1635315772;s:61:"/www/wwwroot/agc.bxtrade.vip/application/index/view/head.html";i:1636641480;s:63:"/www/wwwroot/agc.bxtrade.vip/application/index/view/alyslt.html";i:1636617716;}*/ ?>
...
<!--        夜间白天切换的文件-->
<script>
    var ti_wlfm='<?php echo \think\Lang::get('ti_wlfm'); ?>';
</script>
<?php if($_SESSION["night"]=="yes"): ?><link rel="stylesheet" href="/index/css/trades-index.css" ><?php endif; ?>
                ...
                <div class="qoute-view">
                    ...
                    <div class="qoute-view-content">
						...
						<!-- <?php if(is_array($pro) || $pro instanceof \think\Collection || $pro instanceof \think\Paginator): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                            <ul onClick="parent.location='<?php echo url('goods/goods_heyue',array('pid'=>$vo['pid'],'token'=>$token)); ?>';"  id="pid<?php echo $vo['pid']; ?>">
                                <li>
